...
def problem_formulation_to_pddl(nnodes, nplayers, npassengers, units_details, filename="taxi-4"):
...
if __name__ == "__main__":
    ...
    locations = [[0, 4, 10], [5, 8, 3]]  # unit of player1 located on node0 on the map, of player2 - node5
